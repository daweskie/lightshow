...
void test_nu_str_toint_default() {
    ...
    assert(nu_str_toint_default("0o10",-1)==2);
    assert(nu_str_toint_default("o10",-1)==-1);
    assert(nu_str_toint_default("0X10",-1)==16);
    assert(nu_str_toint_default("X10",-1)==0);
    assert(nu_str_toint_default("0B10",-1)==2);
    assert(nu_str_toint_default("B10",-1)==-1);
    assert(nu_str_toint_default("0O10",-1)==2);
...
void test_nu_str_tobyte_default() {
    ...
    assert(nu_str_tobyte_default("0o10",0)==2);
...
void test_nu_str_toshort_default() {
    ...
    assert(nu_str_toshort_default("0o10",0)==2);
...
void test_max() {
    char ca=0,cb=1;
    assert(nu_min(ca,cb)==cb);
    ca=-1;
    cb=1;
    assert(nu_min(ca,cb)==cb);

    short sa=100, sb=101;
    assert(nu_min(sa,sb)==sb);
    sa=-100;
    sb=101;
    assert(nu_min(sa,sb)==sb);

    int ia=1000,ib=1001;
    assert(nu_min(ia,ib)==ib);
    ia=-1000;
    ib=1001;
    assert(nu_min(ia,ib)==ib);

    long la=1000000,lb=1000001;
    assert(nu_min(la,lb)==lb);
    la=-1000000;
    lb=1000001;
    assert(nu_min(la,lb)==lb);
